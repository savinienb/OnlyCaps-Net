...
if __name__ == "__main__":
    ...
    train_parser.add_argument("--model_name", type=str, default="onlycaps-3d", help="ucaps / onlycaps-3d / unet")
    train_parser.add_argument(
        "--dataset", type=str, default="task02_heart", help="iseg2017 / task02_heart / task04_hippocampus / luna16"
    )
    ...
    train_parser.add_argument("--depthwise_capsule", type=int, default=0)
    train_parser.add_argument("--squash", type=str, default=0)
    train_parser.add_argument("--routing", type=str, default=0)
    ...
    if args.model_name == "ucaps":
        ...
        net = OnlyCaps3D(**dict_args, class_weight=class_weight)
