...
from layers import ConvSlimCapsule3D, ConvSlimCapsule3D, MarginLoss
...
class UCaps3D(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.primary_caps = ConvSlimCapsule3D(
            ...
            squash = self.squash,
            depthwise_capsule = self.depthwise_capsule,
            stride=1,
            padding=1,
            num_routing=1,
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--rec_loss_weight", type=float, default=1e-1*0)
        parser.add_argument("--cls_loss", type=str, default="CE")

        # Optimizer params
        parser.add_argument("--lr_rate", type=float, default=2e-4)#2e-4
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Reconstructing
        reconstructions = x * 0#self.reconstruct_branch(x)
    ...
    def validation_epoch_end(self, outputs):
        ...
        print ("current Val ==", mean_val_dice)
...
#this was modified
    def _build_encoder(self):
        ...
        #self.encoder_output_dim = [8, 8, 8, 8, 8, self.out_channels]
        #self.encoder_output_atoms = [8, 8, 8, 8, 8, 6]
        ...
        for i in range(len(self.encoder_output_dim)):
            ...
            if (i==(len(self.encoder_output_dim)-1)):
    ...
    def _build_decoder(self):
        ...
        if self.connection == "skip":
            ...
            self.decoder_in_channels = [self.out_channels * self.encoder_output_atoms[-1], self.encoder_output_dim[-3]*self.encoder_output_atoms[-3]+self.decoder_out_channels[0], 128, self.encoder_output_dim[-5]*self.encoder_output_atoms[-5]+self.decoder_out_channels[2], 64, 128]
