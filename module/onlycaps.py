...
import torch
from layers import ConvSlimCapsule3D, DeconvSlimCapsule3D, MarginLoss
...
class OnlyCaps3D(pl.LightningModule):
    def __init__(
        self,
        in_channels=2,
        out_channels=4,
    ...
    def add_model_specific_args(parent_parser):
        ...
        # Optimizer params
        parser.add_argument("--lr_rate", type=float, default=2e-3)
    ...
    def forward(self, x):
        ...
        conv_size = x.size()
        conv_cap_1_1 = x.reshape(conv_size[0],12,12,conv_size[-3],conv_size[-2],conv_size[-1])
    ...
    def _build_encoder(self):
        ...
        self.encoder_output_dim = [12, 12,12, 12, 12, 12]
        self.encoder_output_atoms = [12, 12, 12, 12, 12, 12]
    ...
    def _build_decoder(self):
        ...
        self.decoder_input_dim = [12, 24, 12,24, 12,24 ]
        self.decoder_output_dim = [12, 12, 12, 12, 12, self.out_channels]
        self.decoder_output_atoms = [12, 12, 12, 12, 12, 12]
        ...
        for i in range(len(self.decoder_output_dim)):
            ...
            if i % 2 == 0:
                ...
                if (i==(len(self.decoder_output_dim)-1)):
                    self.decoder_conv_caps.append(
                    ConvSlimCapsule3D(
                        kernel_size=5,
                        input_dim=self.decoder_input_dim[i],
